...
Public Class iphone
    ...
    Protected Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        If TextBox1.Text <> "" And TextBox2.Text <> "" And TextBox3.Text <> "" And TextBox4.Text <> "" And TextBox5.Text <> "" Then
            ...
            stok = TextBox5.Text
            yol = Server.MapPath("deneme.accdb")
            sql = " Insert into iphone (telkod,urun,fiyat,aciklama,stok) values ('" & telkodd & "','" & ürün & "','" & fiyat & "','" & aciklama & "','" & stok & "')"
            Dim baglanti As New OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0; Data Source=" & yol)
            Dim komut_kontrol As New OleDbCommand("select * from iphone where telkod= " & telkodd & "", baglanti)
    ...
    Protected Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        telkodd = TextBox1.Text
        yol = Server.MapPath("deneme.accdb")
        sql = " Delete * from iphone Where telkod=" & telkodd & ""
        Dim baglanti As New OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0; Data Source=" & yol)
        Dim komut As New OleDbCommand
        komut.Connection = baglanti
        komut.CommandText = sql
    ...
    Protected Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        ...
        sql = "update iphone set telkod= '" & telkodd & "', urun='" & ürün & "', fiyat='" & fiyat & "', aciklama='" & aciklama & "', stok='" & stok & "' where telkod= " & telkodd & ""
        Dim komut As New OleDbCommand
        komut.CommandText = sql
    ...
    Protected Sub Button4_Click(sender As Object, e As EventArgs) Handles Button4.Click
        ...
        telkodd = TextBox1.Text
        yol = Server.MapPath("deneme.accdb")
        sql = "select * from iphone where telkod= '" & telkodd & "'"
        Dim baglanti As New OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0; Data Source=" & yol)
        Dim komut_kontrol As New OleDbCommand("select * from iphone where telkod= " & telkodd & "", baglanti)
        Dim verioku As OleDbDataReader
        baglanti.Open()
    ...
    Protected Sub Button6_Click(sender As Object, e As EventArgs) Handles Button6.Click
        ...
        urun = TextBox2.Text
        yol = Server.MapPath("deneme.accdb")
        sql = "select * from iphone where urun like '%" & TextBox2.Text & "%'"
        Dim baglanti As New OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=" & yol)
        Dim verial As New OleDbDataAdapter(sql, baglanti)
        Dim ds As New DataSet
        verial.Fill(ds)
