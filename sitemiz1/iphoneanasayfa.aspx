<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site1.Master" CodeBehind="iphoneanasayfa.aspx.vb" Inherits="sitemiz1.kullanıcıgirisi" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <hr />
    <asp:DataList ID="DataList2" runat="server" RepeatColumns="3" RepeatDirection="Horizontal" Height="371px" Width="843px" >
        <ItemTemplate>
            <table>
                <tr>
